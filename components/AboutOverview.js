export default function AboutOverview() {
  ...
  return (
    <section className="bg-white border-b border-ebony/5">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12 py-20 md:py-28 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-7 space-y-8 text-base text-ebony-600 leading-relaxed font-sans">
          ...
          <div className="pt-4 border-t border-ebony/5">
